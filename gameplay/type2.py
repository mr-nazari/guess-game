...
def start(console: Console):
    console.write_line('About: In this game, A random number selected for you and\n'
    ...
    while True:
        ...
        if user_number_check(console, guess_number_user, random_number_user, guess_count):
            break
